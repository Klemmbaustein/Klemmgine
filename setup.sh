...
cmake -S . -B Linux_Distribution/ -DCMAKE_BUILD_TYPE=Distribution -DINTERPROCEDURAL_OPTIMIZATION=OFF -DGENERATE_DEBUG_SYMBOLS=OFF -DUSE_ASSERTS=ON -DENABLE_ALL_WARNINGS=OFF || fail
